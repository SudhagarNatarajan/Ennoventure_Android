...
public class PermissionActivity extends Activity {
    ...
    private void checkAndroidVersion() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            {
               // String IsToggle = (String) toggleButton1.getText();
               // Toast.makeText(this,IsToggle, Toast.LENGTH_LONG).show();

                 Intent intent = new Intent(getApplicationContext(),LowLightGlareBlurDetection.class);
               //  intent.putExtra("IsToggle", IsToggle);
