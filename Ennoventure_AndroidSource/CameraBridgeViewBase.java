 ...
 */
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback, CallbackInterface {
    ...
    public  void TaptoFocus(View v, MotionEvent event)
    {
    ...
    protected Size calculateCameraFrameSize(List<?> supportedSizes, ListItemAccessor accessor, int surfaceWidth, int surfaceHeight) {
        ...
        /*    if (width == 1560 && height == 2080)
            {
                Toast.makeText(cont,"Supported - 1560*2080", Toast.LENGTH_LONG).show();
            }else
            {
                Toast.makeText(cont,"this device not support - 1560*2080", Toast.LENGTH_LONG).show();
            }*/
